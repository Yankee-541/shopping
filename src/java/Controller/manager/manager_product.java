 ...
 * @author Tebellum
 */
@WebServlet(name = "manager_product", urlPatterns = {"/manager/product"})
...
// trả về 1 kiểu string nên là ép sang kiểu object là Account
              ...
              ArrayList<Product> products = pc.getProduct_sellId(id);
